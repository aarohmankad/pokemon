...
//http://answers.unity3d.com/questions/589672/playing-random-animation-by-animator-controller.html
	...
	//var jump : Vector3 = Vector3(0,400,0);
	
	//private var verticalVelocity : float = 0;
	//private var jumpSpeed : int = 50;
...
function FixedUpdate () {
	...
	var distV : Vector3  = directionVertical * speed;
...
{
	directionVertical = transform.rotation * new Vector3(0, 0, Input.GetAxis("Vertical")/speedModify);
	directionHorizontal = transform.rotation * new Vector3(Input.GetAxis("Horizontal"), 0, 0);
	...
	if(directionVertical.magnitude > 1f)
	{
	...
	anim.SetFloat ("Speed", directionVertical.magnitude);
	anim.SetFloat ("Turn", directionHorizontal.magnitude);
